...
description: Recall and preserve durable project knowledge with Starlogz. Use for prior decisions, conventions, architecture, known pitfalls, preferences, or requests to remember a reusable result.
---
